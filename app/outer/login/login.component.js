...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.deleteCookie = function (name) {
        this.setCookie(name, "", -1);
    };
    LoginComponent.prototype.setCookie = function (name, value, expireDays, path) {
        if (path === void 0) { path = ""; }
        var d = new Date();
    ...
    LoginComponent.prototype.consent = function (isConsent, e) {
        if (!isConsent) {
